...
public class JoinOptimizer {
    ...
    public Vector<LogicalJoinNode> orderJoins(
        ...
        // some code goes here
        Vector<LogicalJoinNode> best = new Vector<LogicalJoinNode>();
        int minCostCard = 0;
        ...
        for (int i = 0; i < joins.size(); i++) {
            ...
            for (Set<LogicalJoinNode> s : subsets) {
                ...
                minCostCard = 0;
                best = new Vector<LogicalJoinNode>();
                ...
                for (LogicalJoinNode j : s) {
                    ...
                    cc = computeCostAndCardOfSubplan(stats,
                            filterSelectivities, j, s, minCostThisSubset, cache);
                    if (cc == null)
                        continue;
                ...
                if (minCostThisSubset != Double.MAX_VALUE) {
                    cache.addPlan(s, minCostThisSubset, minCostCard, best);
                }
